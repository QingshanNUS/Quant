...
@author: ryan (https://github.com/691175002/BLPInterface)
"""
import blpapi
import numpy as np
import pandas as pd
...
def main():
    ...
    try:
        ...
        print (blp.historicalRequest('BNS CN Equity', ['PX_LAST', 'PX_VOLUME'], dt.datetime(2014, 12, 31), dt.datetime(2015, 1, 31)))
        ...
        with BLPInterface() as blp:
            ...
            print (blp.bulkRequest('CIGI CN Equity','EQY_DVD_ADJUST_FACT'))
